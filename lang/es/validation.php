...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Traducción al español de los mensajes por defecto de Laravel
    | (vendor/laravel/framework/.../lang/en/validation.php). Sin este
    | archivo, un locale "es" sin traducciones publicadas devuelve las
    | claves crudas (ej. "validation.required") en vez de un mensaje.
    |
    */
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Reemplazan el nombre técnico del campo (ej. "titulo") por uno legible
    | (ej. "título") dentro de los mensajes de arriba.
    |
    */

    'attributes' => [
        // Iniciativas / convites
        'titulo' => 'título',
        'resumen' => 'resumen',
        'historia' => 'historia',
        ...
        'lugar_convite' => 'lugar del convite',
        'lugar_exacto' => 'dirección exacta',
        'fecha_convite' => 'fecha del convite',
        'fecha_convite_texto' => 'fecha del convite',
        'fecha_limite_aportes' => 'fecha límite para aportar',
        'persona_responsable' => 'persona responsable',
        'quien_respalda' => 'quién respalda el convite',
        'telefono_contacto' => 'teléfono de contacto',
        'items' => 'ítems',
        'items.*.nombre' => 'nombre del ítem',
        'items.*.unidad' => 'unidad del ítem',
        'items.*.cantidad_meta' => 'cantidad del ítem',
        'destacada' => 'destacada',
        'nota' => 'nota',
        'nota_moderacion' => 'nota de moderación',
        'punto_acopio_id' => 'punto de acopio',
        'puntos_acopio' => 'puntos de acopio',
        'puntos_acopio.*.nombre' => 'nombre del punto de acopio',
        'puntos_acopio.*.direccion' => 'dirección del punto de acopio',
        'puntos_acopio.*.municipio_id' => 'municipio del punto de acopio',
        'enlace_externo_plataforma' => 'plataforma del enlace externo',
        'enlace_externo_url' => 'URL del enlace externo',
        ...
        'notas_salud' => 'notas de salud',
        'acepta_terminos' => 'aceptación de términos',
        'acepta_descargo' => 'aceptación del descargo de responsabilidad',
        'habilidad_ids' => 'habilidades',
        'disponibilidad_ids' => 'disponibilidad',

        // Aportes
        'asiste_al_convite' => 'asistencia al convite',
        'anonimo' => 'aporte anónimo',
        'recibido' => 'recepción',
        'evidencia' => 'evidencia',
        ...
        'nota_revision' => 'nota de revisión',
    ],
