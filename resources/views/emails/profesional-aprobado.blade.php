...
<head>
    <meta charset="utf-8">
    <title>Tu perfil profesional fue aprobado</title>
</head>
                    ...
                    <tr>
                        <td style="padding:20px 40px 0 40px;font-size:15px;line-height:1.7;color:#4a453e;">
                            <p style="margin:0 0 16px 0;">
                                Hola {{ $profesional->nombre }}, revisamos tu perfil de {{ $profesional->area->label() }}
                                y ya quedó activo. Ya aparecés en el directorio de Manos profesionales.
                            </p>
                            <p style="margin:0 0 16px 0;">
                                Desde tu panel profesional vas a poder ver y gestionar los contactos que te lleguen
                                de la comunidad. Gracias por ofrecer tu tiempo y conocimiento.
                            </p>
                        </td>
                    </tr>
                    <tr>
