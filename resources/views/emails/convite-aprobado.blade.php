...
<head>
    <meta charset="utf-8">
    <title>Tu convite ya está publicado</title>
</head>
                    ...
                    <tr>
                        <td style="padding:20px 40px 0 40px;font-size:15px;line-height:1.7;color:#4a453e;">
                            <p style="margin:0 0 16px 0;">
                                Buenas noticias, {{ $iniciativa->creador->name }}: <strong>"{{ $iniciativa->titulo }}"</strong>
                                ya quedó aprobado y visible para toda la comunidad.
                            </p>
                            <p style="margin:0 0 16px 0;">
                                A partir de ahora la gente puede ver tu convite, ofrecer materiales o su tiempo. Te
                                iremos avisando cada vez que alguien se comprometa a ayudar.
                            </p>
                        </td>
                    </tr>
                    <tr>
